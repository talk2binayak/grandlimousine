<p><?php
	esc_html_e( 'Would you like to boost your website sharing abilities?', 'fleet ' );
?></p>
<p>
<?php
printf(
	esc_html__( 'Don\'t wait, install plugin %s!', 'fleet' ),
	sprintf(
...
"><?php echo esc_html( __( 'Install', 'fleet' ) ); ?></a></p>
